...
@Slf4j
@Builder
public final class TwitchEventSocketPoolPatch implements IEventSubSocket {
    ...
    public Map<String, TwitchSingleUserEventSocketPool> getPoolByUserId() {
        return Map.copyOf(poolByUserId);
    }
