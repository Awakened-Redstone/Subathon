...
@ApiStatus.Internal
public class MobListOptionContainer<T> extends CollapsibleContainer implements OptionValueProvider {
    ...
    public MobListOptionContainer(Option<List<T>> option) {
        super(
    ...
    protected void refreshOptions() {
        ...
        for (int i = 0; i < this.backingList.size(); i++) {
            ...
            box.applyPredicate(v -> Identifier.isValid(v) && Registries.ENTITY_TYPE.containsId(new Identifier(v)));
