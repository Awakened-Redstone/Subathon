...
import com.awakenedredstone.subathon.core.effect.chaos.safe.CompatChaos;
...
public class ChaosRegistry implements AutoRegistryContainer<Chaos> {
    ...
    public static final Chaos HEALTH = new Health();
    ...
    public static final Chaos RANDO_SCREEN_ROTATION = new CompatChaos(new RandoScreenRotation(), "ok-boomer");
    ...
    public static final Chaos REGEN = new Regen();
